...
@section('title', 'Bank Soal - Tugas 2')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Bank Soal - Tugas 2 Untung Subagyo</h1>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('soal.edit',$soal->id) }}" class="btn btn-sm btn-info btn-icon"><i class="fas fa-edit"></i> Edit</a>
                                                    <form action="{{ route('soal.destroy',$soal->id) }}" method="post" class="ml-2">
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                        <button class="btn btn-danger btn-sm btn-icon confirm-delete"><i class="fas fa-times"></i> Delete</button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
